...
def lstm_mel(shape_eeg, shape_spch, units_lstm=64, filters_cnn_eeg=16, filters_cnn_env=16,
    ...
    # output_spch1 = tf.keras.layers.Flatten()(output_spch1)
    # output_spch2 = tf.keras.layers.Flatten()(output_spch2)
    # output_spch3 = tf.keras.layers.Flatten()(output_spch3)
    # output_spch4 = tf.keras.layers.Flatten()(output_spch4)
    # output_spch5 = tf.keras.layers.Flatten()(output_spch5)

    shape = output_spch1.get_shape().as_list() # get the shape of each dimention shape[0] =BATCH_SIZE , shape[1] = HEIGHT , shape[2] = HEIGHT = WIDTH , shape[3] = N_CHANELS
